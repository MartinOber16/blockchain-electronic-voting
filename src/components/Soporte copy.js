...
export default (props) => {
    return <div>
                ...
                <div className="text-justify">
                    ...
                    <br />
                    <p>&emsp;Fuente: <a href="https://es.wikipedia.org/wiki/Voto_electr%C3%B3nico" target="_blank">Voto electrónico. (2020, 19 de marzo). Wikipedia, La enciclopedia libre.</a></p>
                    <br />
                </div>
                <hr />
                <br />
                ...
                <div className="text-justify">
                    ...
                    <br />
                    <p>&emsp;Fuente: <a href="https://es.wikipedia.org/wiki/Cadena_de_bloques" target="_blank">Cadena de bloques. (2020, 11 de febrero). Wikipedia, La enciclopedia libre.</a></p>
                    <br />
                </div>
                <hr />
                <br />
                ...
                <div className="text-justify">
                    ...
                    <div className="text-center">
                        <a href="https://ethereum.org/es/" target="_blank">
                            <img 
                    ...
                    <br />
                    <p>&emsp;Fuente: <a href="https://ethereum.org/es/" target="_blank">ethereum.org</a></p>
                    <br />
                </div>
                <hr />
                <br />
                ...
                <div className="text-justify">
                    ...
                    <br />
                    <p>&emsp;Fuente: <a href="https://metamask.io/" target="_blank">metamask.io</a></p>
                    <br />
                </div>
                <hr />
                <br />
                ...
                <div className="text-justify">
                    <br />
                    <p>&emsp;La votación electrónica en blockchain ofrece importantes ventajas:</p>
                    <ol> 
                        <li>Aumentar el nivel de participación
                        ...
                        <li>Seguridad
                            <p>Cuando hablamos de una elección segura nos referimos a la superposición de capas de seguridad que se aplican para garantizar que los votos contados se ajusten a la voluntad de los votantes y que han sido emitidos por los votantes a los que se les ha permitido participar en la elección.</p>
                        </li>
                        <li>Accesibilidad
                            <p>La votación en blockchain proporciona un canal seguro y privado que permite a todos los usuarios participar en igualdad de condiciones. Mayor accesibilidad para los residentes en el extranjero y para las personas con dificultades para viajar o con movilidad reducida. Esto también tiene un impacto positivo en la participación final y, por lo tanto, en la legitimidad de la elección.</p>
                        </li>
                        <li>Auditabilidad
                            <p>Todo el proceso de votación es auditable de principio a fin. El diseño del sistema permite a los administradores garantizar a los usuarios que sus votos se emiten y contabilizan correctamente según la intención de voto. Además, se emite un recibo de votación para cada usuario.</p>
                        </li>
                        <li>Eficiencia
                            <p>La reducción de los gastos de organización y ejecución aumenta considerablemente la eficiencia de la gestión de las elecciones en comparación con la votación tradicional en papel, por ejemplo.</p>
                        </li>
                        <li>Precisión
                            <p>El voto electrónico elimina los errores en el recuento manual, lo que conlleva una publicación precisa y rápida de los resultados, con la recepción del voto por cada voto emitido.</p>
                        </li>
                        <li>Fiabilidad
                            <p>Los protocolos de cifrado de la tecnología de blockchain son la base de la seguridad, la privacidad y la auditabilidad que proporciona. Conceptos esenciales para garantizar la privacidad y la protección de la integridad de los votos, así como para permitir la auditoría de las elecciones. Una auditoría aún más segura que en el voto por correo tradicional, en el que el votante pierde el control de su voto.</p>
                        </li>
                    </ol>
                    <br />
                    <p>&emsp;Fuente: <a href="https://www.civiciti.info/7-benefits-of-electronic-voting/" target="_blank">Civiciti</a></p>
                    <br />
                </div>
                <hr />
                <br />
